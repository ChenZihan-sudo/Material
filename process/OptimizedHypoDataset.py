...
def read_one_compound_info(id, y, file_path, max_cutoff_distance) -> Data:
    data = Data()
...
def raw_data_process(args, onehot_gen=True, onehot_range: list = None) -> list:
    """
    Args:
...
if cmd_args.run:
    dataset = OptimizedHypoDataset(args)
    print(dataset)
